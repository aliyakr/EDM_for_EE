...
def create_plot():
    data = pd.DataFrame({
        'Код задания': cognitive_load.index,
        'Когнитивная посильность': cognitive_load.values
    })
    return data.hvplot.bar(x='Код задания', y='Когнитивная посильность', color=color_palette, title='Оценка когнитивной посильности по всем заданиям')
...
dashboard = pn.Column(
    '## Оценка когнитивной посильности по всем заданиям',
    plot
)
